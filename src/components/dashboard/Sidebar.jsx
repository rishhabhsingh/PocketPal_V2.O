  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold text-center">Expense Breakdown</h2>
      ...
      <div className="flex justify-between text-center mb-4">
        <div className="flex-1">
          ...
          <p className="text-green-600 font-semibold text-lg">₹{totalIncome}</p>
        </div>
        <div className="flex-1">
      ...
      <p className="font-bold text-gray-700 mb-4">💡 {aiInsight}</p>

      <div className="flex justify-center mt-4">
        <FullReport transactions={filteredTransactions}>
          <Button className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-full px-6 py-2 text-sm shadow-lg transition duration-200 tracking-wide">
            View Full Report
          </Button>
        </FullReport>
      </div>
